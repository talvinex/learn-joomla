...
--
-- Host: localhost
-- Erstellungszeit: 19. Apr 2020 um 14:44
...
--
-- Datenbank: `learn-joomla`
--

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_action_logs`
--

CREATE TABLE `gr1tv_action_logs` (
...
--
-- Daten für Tabelle `gr1tv_action_logs`
--

INSERT INTO `gr1tv_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2020-04-19 12:31:52', 'com_users', 596, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:32:03', 'com_users', 596, 0, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"596\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:32:06', 'com_users', 596, 596, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:32:46', 'com_users', 596, 0, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"596\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:32:54', 'com_users', 596, 596, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:32:55', 'com_users', 596, 0, 'COM_ACTIONLOGS_DISABLED'),
(7, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{\"action\":\"update\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":16,\"title\":\"Login Form\",\"extension_name\":\"Login Form\",\"itemlink\":\"index.php?option=com_modules&task=module.edit&id=16\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\"}', '2020-04-19 12:33:29', 'com_modules.module', 596, 16, 'COM_ACTIONLOGS_DISABLED'),
(8, 'PLG_ACTIONLOG_JOOMLA_USER_CHECKIN', '{\"action\":\"checkin\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_USER\",\"id\":\"596\",\"title\":\"root\",\"itemlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"table\":\"#__modules\"}', '2020-04-19 12:33:29', 'com_checkin', 596, 596, 'COM_ACTIONLOGS_DISABLED'),
(9, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"596\",\"userid\":\"596\",\"username\":\"root\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=596\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2020-04-19 12:33:38', 'com_users', 596, 596, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_action_logs_extensions`
--

CREATE TABLE `gr1tv_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gr1tv_action_logs_extensions`
--

INSERT INTO `gr1tv_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Tabellenstruktur für Tabelle `gr1tv_action_logs_users`
--

CREATE TABLE `gr1tv_action_logs_users` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_action_log_config`
--

CREATE TABLE `gr1tv_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_action_log_config`
--

INSERT INTO `gr1tv_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_assets`
--

CREATE TABLE `gr1tv_assets` (
...
--
-- Daten für Tabelle `gr1tv_assets`
--

INSERT INTO `gr1tv_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_associations`
--

CREATE TABLE `gr1tv_associations` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_banners`
--

CREATE TABLE `gr1tv_banners` (
  `id` int(11) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_banner_clients`
--

CREATE TABLE `gr1tv_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Tabellenstruktur für Tabelle `gr1tv_banner_tracks`
--

CREATE TABLE `gr1tv_banner_tracks` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_categories`
--

CREATE TABLE `gr1tv_categories` (
  `id` int(11) NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_categories`
--

INSERT INTO `gr1tv_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 596, '2020-04-19 12:31:44', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_contact_details`
--

CREATE TABLE `gr1tv_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_content`
--

CREATE TABLE `gr1tv_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Tabellenstruktur für Tabelle `gr1tv_contentitem_tag_map`
--

CREATE TABLE `gr1tv_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Tabellenstruktur für Tabelle `gr1tv_content_frontpage`
--

CREATE TABLE `gr1tv_content_frontpage` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_content_rating`
--

CREATE TABLE `gr1tv_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_content_types`
--

CREATE TABLE `gr1tv_content_types` (
...
--
-- Daten für Tabelle `gr1tv_content_types`
--

INSERT INTO `gr1tv_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_core_log_searches`
--

CREATE TABLE `gr1tv_core_log_searches` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_extensions`
--

CREATE TABLE `gr1tv_extensions` (
...
--
-- Daten für Tabelle `gr1tv_extensions`
--

INSERT INTO `gr1tv_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"b82a18b8431224561b90797c192235b8\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1587299510}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":1,\"lastrun\":1587299514,\"unique_id\":\"40f442034371e3a2c769afc36c656b02ac469334\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Tabellenstruktur für Tabelle `gr1tv_fields`
--

CREATE TABLE `gr1tv_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_fields_categories`
--

CREATE TABLE `gr1tv_fields_categories` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_fields_groups`
--

CREATE TABLE `gr1tv_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Tabellenstruktur für Tabelle `gr1tv_fields_values`
--

CREATE TABLE `gr1tv_fields_values` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_filters`
--

CREATE TABLE `gr1tv_finder_filters` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links`
--

CREATE TABLE `gr1tv_finder_links` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms0`
--

CREATE TABLE `gr1tv_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms1`
--

CREATE TABLE `gr1tv_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms2`
--

CREATE TABLE `gr1tv_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms3`
--

CREATE TABLE `gr1tv_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms4`
--

CREATE TABLE `gr1tv_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms5`
--

CREATE TABLE `gr1tv_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms6`
--

CREATE TABLE `gr1tv_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms7`
--

CREATE TABLE `gr1tv_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms8`
--

CREATE TABLE `gr1tv_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_terms9`
--

CREATE TABLE `gr1tv_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termsa`
--

CREATE TABLE `gr1tv_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termsb`
--

CREATE TABLE `gr1tv_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termsc`
--

CREATE TABLE `gr1tv_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termsd`
--

CREATE TABLE `gr1tv_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termse`
--

CREATE TABLE `gr1tv_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_links_termsf`
--

CREATE TABLE `gr1tv_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_taxonomy`
--

CREATE TABLE `gr1tv_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `title` varchar(255) NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_finder_taxonomy`
--

INSERT INTO `gr1tv_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_finder_taxonomy_map`
--

CREATE TABLE `gr1tv_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_terms`
--

CREATE TABLE `gr1tv_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_terms_common`
--

CREATE TABLE `gr1tv_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Daten für Tabelle `gr1tv_finder_terms_common`
--

INSERT INTO `gr1tv_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_tokens`
--

CREATE TABLE `gr1tv_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_tokens_aggregate`
--

CREATE TABLE `gr1tv_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_finder_types`
--

CREATE TABLE `gr1tv_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_languages`
--

CREATE TABLE `gr1tv_languages` (
...
--
-- Daten für Tabelle `gr1tv_languages`
--

INSERT INTO `gr1tv_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_menu`
--

CREATE TABLE `gr1tv_menu` (
  `id` int(11) NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_menu`
--

INSERT INTO `gr1tv_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_menu_types`
--

CREATE TABLE `gr1tv_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Daten für Tabelle `gr1tv_menu_types`
--

INSERT INTO `gr1tv_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_messages`
--

CREATE TABLE `gr1tv_messages` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_messages_cfg`
--

CREATE TABLE `gr1tv_messages_cfg` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_modules`
--

CREATE TABLE `gr1tv_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Daten für Tabelle `gr1tv_modules`
--

INSERT INTO `gr1tv_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_modules_menu`
--

CREATE TABLE `gr1tv_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gr1tv_modules_menu`
--

INSERT INTO `gr1tv_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Tabellenstruktur für Tabelle `gr1tv_newsfeeds`
--

CREATE TABLE `gr1tv_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_overrider`
--

CREATE TABLE `gr1tv_overrider` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_postinstall_messages`
--

CREATE TABLE `gr1tv_postinstall_messages` (
...
--
-- Daten für Tabelle `gr1tv_postinstall_messages`
--

INSERT INTO `gr1tv_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_privacy_consents`
--

CREATE TABLE `gr1tv_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_privacy_requests`
--

CREATE TABLE `gr1tv_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_redirect_links`
--

CREATE TABLE `gr1tv_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_schemas`
--

CREATE TABLE `gr1tv_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gr1tv_schemas`
--

INSERT INTO `gr1tv_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.16-2020-03-04');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_session`
--

CREATE TABLE `gr1tv_session` (
...
--
-- Daten für Tabelle `gr1tv_session`
--

INSERT INTO `gr1tv_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x3637363061346562666231633530383666653161663531326166363762373431, 0, 1, 1587299619, 'joomla|s:736:\"\";', 0, ''),
(0x6333646539313166346432353635363536353163353037626232626635376134, 1, 0, 1587299652, 'joomla|s:868:\"\";', 596, 'root');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_tags`
--

CREATE TABLE `gr1tv_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Daten für Tabelle `gr1tv_tags`
--

INSERT INTO `gr1tv_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 596, '2020-04-19 12:31:44', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_template_styles`
--

CREATE TABLE `gr1tv_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_template_styles`
--

INSERT INTO `gr1tv_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_ucm_base`
--

CREATE TABLE `gr1tv_ucm_base` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_ucm_content`
--

CREATE TABLE `gr1tv_ucm_content` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_ucm_history`
--

CREATE TABLE `gr1tv_ucm_history` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_updates`
--

CREATE TABLE `gr1tv_updates` (
...
--
-- Daten für Tabelle `gr1tv_updates`
--

INSERT INTO `gr1tv_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Tabellenstruktur für Tabelle `gr1tv_update_sites`
--

CREATE TABLE `gr1tv_update_sites` (
...
--
-- Daten für Tabelle `gr1tv_update_sites`
--

INSERT INTO `gr1tv_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1587299511, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1587299513, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1587299513, '');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_update_sites_extensions`
--

CREATE TABLE `gr1tv_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Daten für Tabelle `gr1tv_update_sites_extensions`
--

INSERT INTO `gr1tv_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Tabellenstruktur für Tabelle `gr1tv_usergroups`
--

CREATE TABLE `gr1tv_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Daten für Tabelle `gr1tv_usergroups`
--

INSERT INTO `gr1tv_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Tabellenstruktur für Tabelle `gr1tv_users`
--

CREATE TABLE `gr1tv_users` (
  `id` int(11) NOT NULL,
...
--
-- Daten für Tabelle `gr1tv_users`
--

INSERT INTO `gr1tv_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(596, 'Super User', 'root', 'tim.dmoch@yahoo.de', '$2y$10$FrL6jE8yOWsGflNLgZvN0uh22k1xgOoD/0XLoR.fI8BO12SIqWaF6', 0, 1, '2020-04-19 12:31:44', '2020-04-19 12:33:38', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_user_keys`
--

CREATE TABLE `gr1tv_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_user_notes`
--

CREATE TABLE `gr1tv_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `gr1tv_user_profiles`
--

CREATE TABLE `gr1tv_user_profiles` (
...
--
-- Tabellenstruktur für Tabelle `gr1tv_user_usergroup_map`
--

CREATE TABLE `gr1tv_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gr1tv_user_usergroup_map`
--

INSERT INTO `gr1tv_user_usergroup_map` (`user_id`, `group_id`) VALUES
(596, 8);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_utf8_conversion`
--

CREATE TABLE `gr1tv_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Daten für Tabelle `gr1tv_utf8_conversion`
--

INSERT INTO `gr1tv_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `gr1tv_viewlevels`
--

CREATE TABLE `gr1tv_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Daten für Tabelle `gr1tv_viewlevels`
--

INSERT INTO `gr1tv_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indizes für die Tabelle `gr1tv_action_logs`
--
ALTER TABLE `gr1tv_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_action_logs_extensions`
--
ALTER TABLE `gr1tv_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `gr1tv_action_logs_users`
--
ALTER TABLE `gr1tv_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indizes für die Tabelle `gr1tv_action_log_config`
--
ALTER TABLE `gr1tv_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `gr1tv_assets`
--
ALTER TABLE `gr1tv_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_associations`
--
ALTER TABLE `gr1tv_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indizes für die Tabelle `gr1tv_banners`
--
ALTER TABLE `gr1tv_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_banner_clients`
--
ALTER TABLE `gr1tv_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indizes für die Tabelle `gr1tv_banner_tracks`
--
ALTER TABLE `gr1tv_banner_tracks`
...
--
-- Indizes für die Tabelle `gr1tv_categories`
--
ALTER TABLE `gr1tv_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_contact_details`
--
ALTER TABLE `gr1tv_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indizes für die Tabelle `gr1tv_content`
--
ALTER TABLE `gr1tv_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indizes für die Tabelle `gr1tv_contentitem_tag_map`
--
ALTER TABLE `gr1tv_contentitem_tag_map`
...
--
-- Indizes für die Tabelle `gr1tv_content_frontpage`
--
ALTER TABLE `gr1tv_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indizes für die Tabelle `gr1tv_content_rating`
--
ALTER TABLE `gr1tv_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indizes für die Tabelle `gr1tv_content_types`
--
ALTER TABLE `gr1tv_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indizes für die Tabelle `gr1tv_extensions`
--
ALTER TABLE `gr1tv_extensions`
...
--
-- Indizes für die Tabelle `gr1tv_fields`
--
ALTER TABLE `gr1tv_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indizes für die Tabelle `gr1tv_fields_categories`
--
ALTER TABLE `gr1tv_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indizes für die Tabelle `gr1tv_fields_groups`
--
ALTER TABLE `gr1tv_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indizes für die Tabelle `gr1tv_fields_values`
--
ALTER TABLE `gr1tv_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indizes für die Tabelle `gr1tv_finder_filters`
--
ALTER TABLE `gr1tv_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indizes für die Tabelle `gr1tv_finder_links`
--
ALTER TABLE `gr1tv_finder_links`
...
--
-- Indizes für die Tabelle `gr1tv_finder_links_terms0`
--
ALTER TABLE `gr1tv_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms1`
--
ALTER TABLE `gr1tv_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms2`
--
ALTER TABLE `gr1tv_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms3`
--
ALTER TABLE `gr1tv_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms4`
--
ALTER TABLE `gr1tv_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms5`
--
ALTER TABLE `gr1tv_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms6`
--
ALTER TABLE `gr1tv_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms7`
--
ALTER TABLE `gr1tv_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms8`
--
ALTER TABLE `gr1tv_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_terms9`
--
ALTER TABLE `gr1tv_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termsa`
--
ALTER TABLE `gr1tv_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termsb`
--
ALTER TABLE `gr1tv_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termsc`
--
ALTER TABLE `gr1tv_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termsd`
--
ALTER TABLE `gr1tv_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termse`
--
ALTER TABLE `gr1tv_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_links_termsf`
--
ALTER TABLE `gr1tv_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indizes für die Tabelle `gr1tv_finder_taxonomy`
--
ALTER TABLE `gr1tv_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_finder_taxonomy_map`
--
ALTER TABLE `gr1tv_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indizes für die Tabelle `gr1tv_finder_terms`
--
ALTER TABLE `gr1tv_finder_terms`
...
--
-- Indizes für die Tabelle `gr1tv_finder_terms_common`
--
ALTER TABLE `gr1tv_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indizes für die Tabelle `gr1tv_finder_tokens`
--
ALTER TABLE `gr1tv_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indizes für die Tabelle `gr1tv_finder_tokens_aggregate`
--
ALTER TABLE `gr1tv_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indizes für die Tabelle `gr1tv_finder_types`
--
ALTER TABLE `gr1tv_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indizes für die Tabelle `gr1tv_languages`
--
ALTER TABLE `gr1tv_languages`
...
--
-- Indizes für die Tabelle `gr1tv_menu`
--
ALTER TABLE `gr1tv_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_menu_types`
--
ALTER TABLE `gr1tv_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indizes für die Tabelle `gr1tv_messages`
--
ALTER TABLE `gr1tv_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indizes für die Tabelle `gr1tv_messages_cfg`
--
ALTER TABLE `gr1tv_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indizes für die Tabelle `gr1tv_modules`
--
ALTER TABLE `gr1tv_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_modules_menu`
--
ALTER TABLE `gr1tv_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indizes für die Tabelle `gr1tv_newsfeeds`
--
ALTER TABLE `gr1tv_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indizes für die Tabelle `gr1tv_overrider`
--
ALTER TABLE `gr1tv_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `gr1tv_postinstall_messages`
--
ALTER TABLE `gr1tv_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indizes für die Tabelle `gr1tv_privacy_consents`
--
ALTER TABLE `gr1tv_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indizes für die Tabelle `gr1tv_privacy_requests`
--
ALTER TABLE `gr1tv_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `gr1tv_redirect_links`
--
ALTER TABLE `gr1tv_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indizes für die Tabelle `gr1tv_schemas`
--
ALTER TABLE `gr1tv_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indizes für die Tabelle `gr1tv_session`
--
ALTER TABLE `gr1tv_session`
...
--
-- Indizes für die Tabelle `gr1tv_tags`
--
ALTER TABLE `gr1tv_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_template_styles`
--
ALTER TABLE `gr1tv_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_ucm_base`
--
ALTER TABLE `gr1tv_ucm_base`
...
--
-- Indizes für die Tabelle `gr1tv_ucm_content`
--
ALTER TABLE `gr1tv_ucm_content`
...
--
-- Indizes für die Tabelle `gr1tv_ucm_history`
--
ALTER TABLE `gr1tv_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indizes für die Tabelle `gr1tv_updates`
--
ALTER TABLE `gr1tv_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indizes für die Tabelle `gr1tv_update_sites`
--
ALTER TABLE `gr1tv_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indizes für die Tabelle `gr1tv_update_sites_extensions`
--
ALTER TABLE `gr1tv_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indizes für die Tabelle `gr1tv_usergroups`
--
ALTER TABLE `gr1tv_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_users`
--
ALTER TABLE `gr1tv_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `gr1tv_user_keys`
--
ALTER TABLE `gr1tv_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indizes für die Tabelle `gr1tv_user_notes`
--
ALTER TABLE `gr1tv_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indizes für die Tabelle `gr1tv_user_profiles`
--
ALTER TABLE `gr1tv_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indizes für die Tabelle `gr1tv_user_usergroup_map`
--
ALTER TABLE `gr1tv_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indizes für die Tabelle `gr1tv_viewlevels`
--
ALTER TABLE `gr1tv_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT für Tabelle `gr1tv_action_logs`
--
ALTER TABLE `gr1tv_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_action_logs_extensions`
--
ALTER TABLE `gr1tv_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_action_log_config`
--
ALTER TABLE `gr1tv_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_assets`
--
ALTER TABLE `gr1tv_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_banners`
--
ALTER TABLE `gr1tv_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_banner_clients`
--
ALTER TABLE `gr1tv_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_categories`
--
ALTER TABLE `gr1tv_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_contact_details`
--
ALTER TABLE `gr1tv_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_content`
--
ALTER TABLE `gr1tv_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_content_types`
--
ALTER TABLE `gr1tv_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_extensions`
--
ALTER TABLE `gr1tv_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_fields`
--
ALTER TABLE `gr1tv_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_fields_groups`
--
ALTER TABLE `gr1tv_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_finder_filters`
--
ALTER TABLE `gr1tv_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_finder_links`
--
ALTER TABLE `gr1tv_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_finder_taxonomy`
--
ALTER TABLE `gr1tv_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_finder_terms`
--
ALTER TABLE `gr1tv_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_finder_types`
--
ALTER TABLE `gr1tv_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_languages`
--
ALTER TABLE `gr1tv_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_menu`
--
ALTER TABLE `gr1tv_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_menu_types`
--
ALTER TABLE `gr1tv_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_messages`
--
ALTER TABLE `gr1tv_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_modules`
--
ALTER TABLE `gr1tv_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_newsfeeds`
--
ALTER TABLE `gr1tv_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_overrider`
--
ALTER TABLE `gr1tv_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT für Tabelle `gr1tv_postinstall_messages`
--
ALTER TABLE `gr1tv_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_privacy_consents`
--
ALTER TABLE `gr1tv_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_privacy_requests`
--
ALTER TABLE `gr1tv_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_redirect_links`
--
ALTER TABLE `gr1tv_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_tags`
--
ALTER TABLE `gr1tv_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_template_styles`
--
ALTER TABLE `gr1tv_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_ucm_content`
--
ALTER TABLE `gr1tv_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_ucm_history`
--
ALTER TABLE `gr1tv_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_updates`
--
ALTER TABLE `gr1tv_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_update_sites`
--
ALTER TABLE `gr1tv_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_usergroups`
--
ALTER TABLE `gr1tv_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_users`
--
ALTER TABLE `gr1tv_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=597;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_user_keys`
--
ALTER TABLE `gr1tv_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_user_notes`
--
ALTER TABLE `gr1tv_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gr1tv_viewlevels`
--
ALTER TABLE `gr1tv_viewlevels`
